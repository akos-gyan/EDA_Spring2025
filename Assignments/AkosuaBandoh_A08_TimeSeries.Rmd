...
ggplot(GaringerOzone.monthly, aes(x = Date, y = MonthlyMeanOzone)) +
  ...
  labs(
    title = "Ozone Concentrations",
    x = "Date",
    y = "Monthly Concentration (ppm)"  # Fixed missing quote at end of 'y' label
  )
...
GaringerOzone.monthly.seasonal <- GaringerOzone.monthly.ts - Decomposed_GaringerOzone_monthly_Fill$time.series[, "seasonal"]
